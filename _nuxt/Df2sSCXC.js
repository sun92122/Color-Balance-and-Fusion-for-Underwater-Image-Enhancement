import{s as c}from"./cNaTgJ2R.js";import{s as d,a as m}from"./CZDyWzNF.js";import{s as g}from"./Mt4XZ6UA.js";import{I as p,J as u,a7 as f,v as a,x as i,Z as t,Y as b,X as h,a0 as o,a3 as y}from"./vUeD5rKf.js";import"./CkHEsmfq.js";var w=p`
    .p-inlinemessage {
        display: inline-flex;
        align-items: center;
...
`,v={root:function(s){var n=s.props,r=s.instance;return["p-inlinemessage p-component p-inlinemessage-"+n.severity,{"p-inlinemessage-icon-only":!r.$slots.default}]},icon:function(s){var n=s.props;return["p-inlinemessage-icon",n.icon]},text:"p-inlinemessage-text"},x=u.extend({name:"inlinemessage",style:w,classes:v}),k={name:"BaseInlineMessage",extends:f,props:{severity:{type:String,default:"error"},icon:{type:String,default:void 0}},style:x,provide:function(){return{$pcInlineMessage:this,$parentInstance:this}}},$={name:"InlineMessage",extends:k,inheritAttrs:!1,timeout:null,data:function(){return{visible:!0}},mounted:function(){var s=this;this.sticky||setTimeout(function(){s.visible=!1},this.life)},computed:{iconComponent:function(){return{info:m,success:c,warn:d,error:g}[this.severity]}}};function I(e,s,n,r,B,l){return i(),a("div",o({role:"alert","aria-live":"assertive","aria-atomic":"true",class:e.cx("root")},e.ptmi("root")),[t(e.$slots,"icon",{},function(){return[(i(),h(y(e.icon?"span":l.iconComponent),o({class:e.cx("icon")},e.ptm("icon")),null,16,["class"]))]}),e.$slots.default?(i(),a("div",o({key:0,class:e.cx("text")},e.ptm("text")),[t(e.$slots,"default")],16)):b("",!0)],16)}$.render=I;export{$ as default};
